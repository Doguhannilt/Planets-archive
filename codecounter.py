...
# Figlet ile metni büyük ve şekilli bir şekilde yazdırma fonksiyonu
...
# Bu fonksiyon, belirtilen uzantılara sahip dosyalardaki toplam satır sayısını döndürür
...
if __name__ == "__main__":
    ...
    # Renkli ve büyük yazıyla metni profesyonel bir şekilde yazdırın
